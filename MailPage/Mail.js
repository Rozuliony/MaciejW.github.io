...
function AddMessage() {
  ...
  Div.innerHTML = '<div class="SubjectInfo">' + subjectemail.value + '</div><div class="BodyInfo">' + bodyemail.value + '</div><div class="ReceiverInfo">' + receiveremail.value + '</div><img class="TrashIcon" id="EI' + i + '"src="/images/trash.png">';
  i++;
  localStorage.setItem("E" + EndLength, JSON.stringify(Div.innerHTML));
}
